        ...
        try {
            ...
            if (manifest) {
                ...
                if (!fs.existsSync(manifest.manifestPath)) {
                    throw new core_1.SfError(`The manifest path "${manifest.manifestPath}" does not exist.`);
                }
            ...
            if (org) {
                ...
                const fromConnection = await collections_1.ComponentSet.fromConnection({
                    ...
                    componentFilter: (component) => !org.exclude?.includes(component?.manageableState),
                });
