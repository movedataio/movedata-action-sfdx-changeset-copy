 ...
 */
const describeField = (objDescribe, fieldName) => (0, exports.describeObjFields)(objDescribe).find((field) => field.fullName === fieldName);
 ...
 * @returns Promise - Promise - record in JSON format
 */
const describeObjFields = (objDescribe) => objDescribe.fields;
exports.describeObjFields = describeObjFields;
const cleanQueryResponse = (sObjectRecord, objectDescribe) => Object.fromEntries(Object.entries(sObjectRecord)
