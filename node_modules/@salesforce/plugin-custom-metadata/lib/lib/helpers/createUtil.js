...
class CreateUtil {
    ...
    async createRecord(createConfig) {
        ...
        const newRecordContent = getRecordTemplate(createConfig.label, createConfig.protected, this.buildCustomFieldXml(createConfig.fileData, createConfig.varargs, createConfig.ignorefields));
 ...
 * @return {string} String representation of XML
 */
const getRecordTemplate = (label, protection, values) => `
