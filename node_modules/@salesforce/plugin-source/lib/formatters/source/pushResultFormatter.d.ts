...
export declare class PushResultFormatter extends ResultFormatter {
    ...
    constructor(logger: Logger, ux: UX, options: ResultFormatterOptions, results: DeployResult[], deletes?: string[]);
    /**
     * Get the JSON output from the DeployResult.
     *
     * @returns a JSON formatted result matching the provided type.
     */
    getJson(): PushResponse;
    /**
    ...
    private componentsFromFilenames;
    private resolveComponentsOrWarn;
}
export declare const mergeReplacements: (results: DeployResult[]) => DeployResult['replacements'];
