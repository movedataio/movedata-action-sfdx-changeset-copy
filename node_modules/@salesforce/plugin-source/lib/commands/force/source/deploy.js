...
class Deploy extends deployCommand_1.DeployCommand {
    ...
    async deploy() {
        ...
        if (this.flags.validateddeployrequestid) {
            ...
            this.lifecycle.on('apiVersionDeploy', async (apiData) => {
                this.ux.log(deployMessages.getMessage('apiVersionMsgDetailed', [
                    'Deploying',
    ...
    formatResult() {
        this.resultsDir = this.resolveOutputDir(this.getFlag('coverageformatters', undefined), this.getFlag('junit'), this.getFlag('resultsdir'), this.deployResult?.response?.id, false);
