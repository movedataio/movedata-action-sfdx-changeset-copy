...
class PackageVersionCreateListCommand extends PackagingToolbeltCommand_1.PackagingToolbeltCommand {
    async run() {
        const context = await this.resolveLegacyContext();
        const PackageVersionCreateRequestListCommand = require('../../../../../lib/package/packageVersionCreateRequestListCommand');
        return this.execPackagingLegacyCommand(this.id, new PackageVersionCreateRequestListCommand(), context);
    }
}
