...
class PackageInstalledListCommand extends PackagingToolbeltCommand_1.PackagingToolbeltCommand {
    async run() {
        const context = await this.resolveLegacyContext();
        const packageInstalledListCommand = require('../../../../lib/package/packageInstalledListCommand');
        return this.execPackagingLegacyCommand(this.id, new packageInstalledListCommand.packageInstalledListCommand(), context);
    }
}
