        ...
        if (plan) {
            ...
            try {
                ...
                if (error.name === 'ValidationSchemaFieldErrors') {
                    throw new core_1.SfError(messages.getMessage('dataPlanValidationError', [planPath, error.message]), INVALID_DATA_IMPORT_ERR_NAME, messages.getMessages('dataPlanValidationErrorActions', [
                        this.cli,
                        this.separator,
                        this.separator,
                        this.cli,
