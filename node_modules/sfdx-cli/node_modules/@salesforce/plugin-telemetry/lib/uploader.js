        ...
        try {
            ...
            for (const event of events) {
                ...
                if (eventType === telemetry_2.default.EVENT) {
                    ...
                    event.orgId = await getOrgId(false, (0, ts_types_1.asString)(event.orgUsername));
                    // eslint-disable-next-line no-await-in-loop
                    event.devHubId = await getOrgId(true, (0, ts_types_1.asString)(event.devHubUsername));
...
const getOrgId = async (isDevHub, aliasOrUsername) => {
