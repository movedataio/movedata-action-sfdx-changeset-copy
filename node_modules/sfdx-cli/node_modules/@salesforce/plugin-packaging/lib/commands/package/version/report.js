...
class PackageVersionReportCommand extends sf_plugins_core_1.SfCommand {
    ...
    massageResultsForDisplay(results) {
        ...
        record.ConvertedFromVersionId ?? (record.ConvertedFromVersionId = ' ');
...
PackageVersionReportCommand.aliases = ['force:package:beta:version:report', 'force:package:version:report'];
